...
function [W E seed min_err min_iter] = train_batch_variable(T, S, h, H, out, eta=0.01, momentum=0.9, batch_size=60, error_epsilon = .001, max_iters = 10000, lo_rand_interv=-.5, hi_rand_interv=.5)
 W = {};
 E = [];
 seed = rand("seed");
